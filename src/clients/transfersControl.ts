...
export default class TransferControlClient {
  ...
  resendOtp(transferCode: string, reason: Reason){
    return this.client.call('/transfer/resend_otp', HTTPMethod.POST,{transferCode, reason})
  }
  ...
  finalizeDisableOtp(otp: string){
    return this.client.call('/transfer/disable_otp_finalize', HTTPMethod.POST, {otp})
  }
