...
import { PaystackClient, PaystackClientError, type InitiateTransferPayload } from "../mod.ts";
...
describe("PaystackClient.transfers", () => {
  ...
  it("PaystackClient.transfers.initiate", async () => {
    ...
    const payload: InitiateTransferPayload = {amount: 10_000, recipient:'RCP_1l58m5unz4028z5',source: 'balance' }
    ...
    assertEquals(data.message,'You cannot initiate third party payouts as a starter business')
