...
import { Currency, PaystackClient, PaystackClientError, type InitializeTransactionPayload, type PartialDebitPayload, type TransactionChargePayload } from "../mod.ts";
...
describe("PaystackClient.transactions", () => {
  ...
  it("PaystackClient.transactions.partialDebit",async () => {
    ...
    const err =await assertRejects(() => client.transactions.partialDebit(payload))
